...
public class Enrollment extends JPanel implements ActionListener {
    ...
    private void saveTemplate(final byte[] data) {
        ...
        Thread save = new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                File file = new File(barcode + ".fmt");
                ...
                try {
                 ...
                 //   try {
                        //   So.checkFmtExisits();
                 //       Enrollment.invoke("csbc.attendence.RoomSelect", "say", new Class[]{String.class, String.class},
                 //               new Object[]{new String(barcode), new String(barcode)});
                //    } catch (Exception ex) {
