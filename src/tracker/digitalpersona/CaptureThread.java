...
public class CaptureThread extends Thread {
    ...
    public class CaptureEvent extends ActionEvent {
        ...
        public CaptureEvent(Object source, String action, Reader.CaptureResult cr, Reader.Status st, UareUException ex, Fid _image) {
            super(source, ActionEvent.ACTION_PERFORMED, action);
            capture_result = cr;
            reader_status = st;
            exception = ex;
    ...
    private void NotifyListener(String action, Reader.CaptureResult cr, Reader.Status st, UareUException ex, Fid _image) {
        final CaptureEvent evt = new CaptureEvent(this, action, cr, st, ex, _image);
